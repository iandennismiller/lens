...
# installed.
TCL_PREFIX='/export/home/barmstrong/Lens/Bin/x86_64'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/export/home/barmstrong/Lens/Bin/x86_64'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/export/home/barmstrong/Lens/TclTk/tcl8.3.4/unix -ltcl8.3${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/export/home/barmstrong/Lens/Bin/x86_64/lib -ltcl8.3${TCL_DBGX}'
...
# compiled.
TCL_SRC_DIR='/export/home/barmstrong/Lens/TclTk/tcl8.3.4'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/export/home/barmstrong/Lens/Bin/x86_64/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/export/home/barmstrong/Lens/TclTk/tcl8.3.4/unix -ltclstub8.3${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/export/home/barmstrong/Lens/Bin/x86_64/lib -ltclstub8.3${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/export/home/barmstrong/Lens/TclTk/tcl8.3.4/unix/libtclstub8.3${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/export/home/barmstrong/Lens/Bin/x86_64/lib/libtclstub8.3${TCL_DBGX}.a'
