...
struct network {
  ...
  // dcp
  real       targetOneRadius;
  real       targetZeroScaling;
  real       zeroErrorRadius;
  real       parallelBatchScaling;
  real       dt;
  real       gain;
  real	     outputGain;
...
struct group {
  ...
  real	     actDecayTime;
  real       decayConstant;
  real	     decayNoiseRange;
  real 	     invSquareTuning; 
  real 	     elbowPoint;
  real	     maxTick;
  real	     IPSPthreshold;
