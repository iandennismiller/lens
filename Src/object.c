...
static void initNetInfo(void) {
  ...
  addMember(NetInfo, "groupCritRequired", OBJ, OFFSET(N, groupCritRequired), 
	    TRUE, 0, 0, FlagInfo);
  // dcp
  addMember(NetInfo, "parallelSplit", OBJ, OFFSET(N, parallelSplit), 
	    TRUE, 0, 0, IntInfo);
  addMember(NetInfo, "numExamplesCorrect", OBJ, OFFSET(N, numExamplesCorrect), TRUE, 
	    0, 0, IntInfo);
  addMember(NetInfo, "incrementalNumIncorrect", OBJ, OFFSET(N, incrementalNumIncorrect), TRUE, 
	    0, 0, IntInfo);
  ...
  //sl
  addMember(NetInfo, "IPSPthreshold", OBJ, OFFSET(N, IPSPthreshold),
	TRUE, 0, 0, RealInfo);
  addMember(NetInfo, "decayConstant", OBJ, OFFSET(N, decayConstant),
	TRUE, 0, 0, RealInfo);
  ...
  addMember(NetInfo, "weightDecay", OBJ, OFFSET(N, weightDecay), TRUE, 
	    0, 0, RealInfo);
  addMember(NetInfo, "weightEliminationW0", OBJ, OFFSET(N, weightEliminationW0), TRUE, 
	    0, 0, RealInfo);
  ...
  addMember(NetInfo, "targetRadius", OBJ, OFFSET(N, targetRadius), TRUE,
	    0, 0, RealInfo);
  addMember(NetInfo, "targetOneRadius", OBJ, OFFSET(N, targetOneRadius), TRUE,
	    0, 0, RealInfo);
  addMember(NetInfo, "targetZeroScaling", OBJ, OFFSET(N, targetZeroScaling), TRUE,
	    0, 0, RealInfo);
  addMember(NetInfo, "zeroErrorRadius", OBJ, OFFSET(N, zeroErrorRadius), TRUE,
	    0, 0, RealInfo);
  addMember(NetInfo, "parallelBatchScaling", OBJ, OFFSET(N, parallelBatchScaling), TRUE,
	    0, 0, RealInfo);
  addSpacer(NetInfo);
  ...
  addMember(NetInfo, "gain", OBJ, OFFSET(N, gain), TRUE,
	    0, 0, RealInfo);
  addMember(NetInfo, "outputGain", OBJ, OFFSET(N, outputGain), TRUE,
	    0, 0, RealInfo);
  ...
  addMember(NetInfo, "initOutput", OBJ, OFFSET(N, initOutput), TRUE, 
	    0, 0, RealInfo);
  addMember(NetInfo, "initOutputRange", OBJ, OFFSET(N, initOutputRange), TRUE, 
	    0, 0, RealInfo);
...
static void initGroupInfo(void) {
  ...
  addMember(GroupInfo, "weightDecay", OBJ, OFFSET(G, weightDecay), TRUE, 
	    0, 0, RealInfo);
  addMember(GroupInfo, "weightEliminationW0", OBJ, OFFSET(G, weightEliminationW0), TRUE, 
	    0, 0, RealInfo);
  addMember(GroupInfo, "gainDecay", OBJ, OFFSET(G, gainDecay), TRUE, 
	    0, 0, RealInfo);
  addMember(GroupInfo, "targetRadius", OBJ, OFFSET(G, targetRadius), TRUE,
	    0, 0, RealInfo);
  addMember(GroupInfo, "targetOneRadius", OBJ, OFFSET(G, targetOneRadius), TRUE,
	    0, 0, RealInfo);
  addMember(GroupInfo, "targetZeroScaling", OBJ, OFFSET(G, targetZeroScaling), TRUE,
	    0, 0, RealInfo);
  ...
  addMember(GroupInfo, "polarityNum", OBJ, OFFSET(G, polarityNum), TRUE, 
	    0, 0, IntInfo);
  // dcp
  addMember(GroupInfo, "graceTick", OBJ, OFFSET(G, graceTick), TRUE, 
	    0, 0, IntInfo);
  addMember(GroupInfo, "actDecay", OBJ, OFFSET(G, actDecay), TRUE, 
	    0, 0, RealInfo);
  addMember(GroupInfo, "actRest", OBJ, OFFSET(G, actRest), TRUE, 
	    0, 0, RealInfo);
  addSpacer(GroupInfo);

  //sl
  addMember(GroupInfo, "actDecayTime", OBJ, OFFSET(G, actDecayTime), TRUE,
	   0, 0, RealInfo);
  addMember(GroupInfo, "decayConstant", OBJ, OFFSET(G, decayConstant), TRUE,
	   0,0, RealInfo);
  addMember(GroupInfo, "decayNoiseRange", OBJ, OFFSET(G, decayNoiseRange), TRUE,
	    0,0, RealInfo);
  addMember(GroupInfo, "invSquareTuning", OBJ, OFFSET(G, invSquareTuning), TRUE,
	0,0, RealInfo);
  addMember(GroupInfo, "elbowPoint", OBJ, OFFSET(G, elbowPoint), TRUE, 0,0, RealInfo);
  addMember(GroupInfo, "maxTick", OBJ, OFFSET(G, maxTick), TRUE, 0,0, RealInfo);
  addMember(GroupInfo, "IPSPthreshold", OBJ, OFFSET(G, IPSPthreshold), TRUE, 0,0, RealInfo);
  ...
  addMember(GroupInfo, "gain", OBJ, OFFSET(G, gain), TRUE,
	    0, 0, RealInfo);
  addMember(GroupInfo, "outputGain", OBJ, OFFSET(G, outputGain), TRUE,
	    0, 0, RealInfo);
  ...
  addMember(GroupInfo, "initOutput", OBJ, OFFSET(G, initOutput), TRUE, 
	    0, 0, RealInfo);
  addMember(GroupInfo, "initOutputRange", OBJ, OFFSET(G, initOutputRange), TRUE, 
	    0, 0, RealInfo);
...
static void initUnitInfo(void) {
  ...
  addMember(UnitInfo, "plotCol", OBJ, OFFSET(U, plotCol), FALSE, 
	    0, 0, IntInfo);
//sl
  addMember(UnitInfo, "activeTicks", OBJ, OFFSET(U, activeTicks), TRUE, 0,0,  UnitInfo);
}
...
static void initBlockInfo(void) {
  ...
  addMember(BlockInfo, "weightDecay", OBJ, OFFSET(B, weightDecay), TRUE, 
	    0, 0, RealInfo);
  addMember(BlockInfo, "weightEliminationW0", OBJ, OFFSET(B, weightEliminationW0), TRUE, 
	    0, 0, RealInfo);
