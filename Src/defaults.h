...
/* dcp */
#define DEF_N_weightEliminationW0 0.0
...
#define DEF_N_targetZeroScaling   1.0
...
#define DEF_N_initOutputRange        0.0
...
#define DEF_G_initOutput          NaN
#define DEF_G_initOutputRange     NaN
#define DEF_G_initInput           NaN
...
/* dcp */
#define DEF_B_weightEliminationW0 NaN
...
#define AUTO_NICE_VALUE  0        /* Long-running process renice value */
